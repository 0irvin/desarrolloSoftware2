        ...
        <form name="form-add-administratives" action="insert.php" method="POST" autocomplete="off" autocapitalize="on">
            <div class="wrap">
                <div class="first">
                    ...
                    <input id="txtusercurp" class="text" type="text" name="txtcurp" value="" placeholder="Documento Nacional Identidad" pattern="[0-9]{8}" maxlength="8" onkeyup="this.value = this.value.toUpperCase()" required />
                </div>
                <div class="last">
                    <label for="txtuserrfc" class="label">RUC</label>
                    <input id="txtuserrfc" class="text" type="text" name="txtrfc" value="" placeholder="12345698712" maxlength="11" onkeyup="this.value = this.value.toUpperCase()" required />
