		...
		<form name="form-update-administratives" action="update.php" method="POST" autocomplete="off" autocapitalize="on">
			<div class="wrap">
				<div class="first">
					...
					<input id="txtusercurp" class="text" type="text" name="txtcurp" value="<?php echo $_SESSION['administrative_curp']; ?>" placeholder="Documento Ncional Identidad" pattern="[0-9]{8}" maxlength="8" onkeyup="this.value = this.value.toUpperCase()" required />
				</div>
				<div class="last">
					<label for="txtuserrfc" class="label">RUC</label>
					<input id="txtuserrfc" class="text" type="text" name="txtrfc" value="<?php echo $_SESSION['administrative_rfc']; ?>" placeholder="23654789632" pattern="[0-9]{11}" maxlength="11" onkeyup="this.value = this.value.toUpperCase()"  />
