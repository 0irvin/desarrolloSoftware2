        ...
        <form name="form-add-students" action="insert.php" method="POST" autocomplete="off" autocapitalize="on">
            <div class="wrap">
                ...
                <div class="last">
                    ...
                    <input id="txtuserrfc" class="text" type="text" name="txtrfc" value="" placeholder="12345678912" pattern="[A-Za-z0-9]{11}" maxlength="11" onkeyup="this.value = this.value.toUpperCase()"  />
                    <label for="txtuserphone" class="label">Número de teléfono</label>
                    <input id="txtuserphone" class="text" type="text" name="txtphone" value="" placeholder="9998887766" pattern="[0-9]{19}" title="Ingresa un número de teléfono válido." maxlength="10" required />
