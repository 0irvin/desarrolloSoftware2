		...
		<form name="form-update-students" action="update.php" method="POST" autocomplete="off" autocapitalize="on">
			<div class="wrap">
				...
				<div class="last">
					...
					<input id="txtusercurp" class="text" type="text" name="txtcurp" value="<?php echo $_SESSION['student_curp']; ?>" placeholder="Clave Única de Registro de Población"  onkeyup="this.value = this.value.toUpperCase()" required />
					<label for="txtuserrfc" class="label">RUC</label>
					<input id="txtuserrfc" class="text" type="text" name="txtrfc" value="<?php echo $_SESSION['student_rfc']; ?>" placeholder="12365478965"  maxlength="11" onkeyup="this.value = this.value.toUpperCase()" />
					<label for="txtuserphone" class="label">Número de teléfono</label>
					<input id="txtuserphone" class="text" type="text" name="txtphone" value="<?php echo $_SESSION['student_phone']; ?>" pattern="[0-9]{9}" title="Ingresa un número de teléfono válido." placeholder="999888776" maxlength="9" required />
