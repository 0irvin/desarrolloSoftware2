        ...
        <form name="form-add-teachers" action="insert.php" method="POST" autocomplete="off" autocapitalize="on">
            <div class="wrap">
                ...
                <div class="last">
                    ...
                    <input id="txtusercurp" class="text" type="text" name="txtcurp" value="" placeholder="Documento Nacional de Identidad" pattern="[0-9]{8}" maxlength="8" onkeyup="this.value = this.value.toUpperCase()" required />
                    <label for="txtuserrfc" class="label">RUC</label>
                    <input id="txtuserrfc" class="text" type="text" name="txtrfc" value="" placeholder="00000000000" pattern="[0-9]{11}" maxlength="11" onkeyup="this.value = this.value.toUpperCase()" />
                    <label for="txtuserphone" class="label">Número de teléfono</label>
                    <input id="txtuserphone" class="text" type="text" name="txtphone" value="" placeholder="9998887766" pattern="[0-9]{9}" title="Ingresa un número de teléfono válido." maxlength="10" required />
