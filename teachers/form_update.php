	...
	<div class="body">
		<form name="form-update-teachers" action="update.php" method="POST" autocomplete="off" autocapitalize="on">
			<div class="wrap">
				...
				<div class="last">
					<label for="txtusercurp" class="label">DNI</label>
					<input id="txtusercurp" class="text" type="text" name="txtcurp" value="<?php echo $_SESSION['teacher_curp']; ?>" placeholder="Documneto Nacional Identidad" pattern="[0-9]{8}" maxlength="8" onkeyup="this.value = this.value.toUpperCase()" required />
					<label for="txtuserrfc" class="label">RUC</label>
					<input id="txtuserrfc" class="text" type="text" name="txtrfc" value="<?php echo $_SESSION['teacher_rfc']; ?>" placeholder="00000000000" pattern="[0-9]{11}" maxlength="13" onkeyup="this.value = this.value.toUpperCase()" required />
					<label for="txtuserphone" class="label">Número de teléfono</label>
					<input id="txtuserphone" class="text" type="text" name="txtphone" value="<?php echo $_SESSION['teacher_phone']; ?>" pattern="[0-9]{9}" title="Ingresa un número de teléfono válido." placeholder="999888776" maxlength="9" required />
